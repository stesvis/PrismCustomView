...
namespace PrismCustomView.CustomViewCells
{
    ...
    public partial class TestEntryCell : ViewCell
    {
        ...
        public static readonly BindableProperty TextProperty = BindableProperty.Create(nameof(Text), typeof(string), typeof(TestEntryCell), defaultBindingMode: BindingMode.TwoWay);
